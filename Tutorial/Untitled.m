...
%     
    ...
    if k==1
        ...
        if length (date2)==length (data_end)
            ...
            fprintf (2,'                                       OU OS DADOS ESTÃO INCOMPLETOS\n\n')
            
            fprintf (2,'                                        VERIFIQUE NA PLANILHA EXCEL\n\n')
            
            fprintf (2,'////////////////////////////////////////////////////////////////////////////////////////////////////////////////\n\n')
            
            clearvars A c data_end data_end1 date2 h i J p y dados extracted_data j k K L linhas match name_area resposta titulo UIControl_FontSize_bak year year_01 year_02
    ...
    fprintf(2,'                                   OS DADOS NÃO ESTÃO COMPLETOS\n\n');
